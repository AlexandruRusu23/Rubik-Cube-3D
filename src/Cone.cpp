...
void Cone::Create()
{
  ...
  vertices.push_back(VertexFormat(glm::vec3( 0.0, 2.0, 0.0), glm::vec4(1, 1, 1, 1)));
  vertices.push_back(VertexFormat(glm::vec3( 0.0, 2.0, 0.0), glm::vec4(0, 1, 1, 1)));

  //right
  vertices.push_back(VertexFormat(glm::vec3( 0.0, 2.0, 0.0), glm::vec4(1, 1, 1, 1)));
  vertices.push_back(VertexFormat(glm::vec3( 0.0, 2.0, 0.0), glm::vec4(1, 1, 0, 1)));
  ...
  vertices.push_back(VertexFormat(glm::vec3( 1.0, -1.0, -1.0), glm::vec4(1, 0, 0, 1)));
  vertices.push_back(VertexFormat(glm::vec3( 0.0, 2.0, 0.0), glm::vec4(1, 1, 0, 1)));
  vertices.push_back(VertexFormat(glm::vec3( 0.0, 2.0, 0.0), glm::vec4(0, 1, 0, 1)));
  ...
  rotation_speed = glm::vec3(0.0, 10.0, 0.0);
  rotation = glm::vec3(0.0, 0.0, 0.0);
  translate = glm::vec3(0.0, 6.0, 0.0);
...
void Cone::Move(int areaId, int directionId)
{

}

void Cone::Draw(const glm::mat4& projection_matrix, const glm::mat4& view_matrix)
{
    glUniform1i(0, 1);
